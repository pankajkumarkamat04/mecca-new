...
export const routePermissionMap: Array<{
  ...
  { prefix: '/reports-analytics', permission: { module: 'reports', action: 'read' } },
  { prefix: '/sales-report', permission: { module: 'sales', action: 'read' } },
  { prefix: '/outlet-sales-report', permission: { module: 'sales', action: 'read' } },
