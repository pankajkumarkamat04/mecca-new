...
import { z } from 'zod'
import { EyeIcon, EyeSlashIcon, UserPlusIcon, EnvelopeIcon, LockClosedIcon, PhoneIcon, BuildingOfficeIcon } from '@heroicons/react/24/outline'
          ...
          <div className="space-y-6">
            ...
            <div className="text-center pt-2">
              <p className="text-xs text-gray-500">
                ...
                <Link href="/terms" className="font-medium text-red-600 hover:text-red-500 transition-colors">
                  Terms of Service
                </Link>{' '}
                and{' '}
                <Link href="/privacy" className="font-medium text-red-600 hover:text-red-500 transition-colors">
                  Privacy Policy
                </Link>
              </p>
            </div>
